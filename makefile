...
SRCS = main.cpp lib/near_entropic.cpp lib/combinations.cpp lib/permutations.cpp lib/rgf.cpp lib/io_lib.cpp lib/base_lib.cpp lib/nearer_entropic.cpp lib/set_partitions.cpp
OBJS = $(SRCS:.cpp=.o)
TARGET = decimate
